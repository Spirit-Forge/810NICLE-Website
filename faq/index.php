...
<body>
	...
	<a id="mod-logo-wrapper" href="https://linktr.ee/MaskofDestiny" target="_blank">
		...
		<header>
			<div class="center">
				<video id="BannerLoop" autoplay loop muted playsinline width=75%>				
	...
	<main>
		<h2><a href="../home">Home</a> | <span class="disabled">FAQ</span> | <a href="../cards">Cards</a> | <a href="../schedule">Schedule</a> | <a href="../watch">Watch</a> | <a href="../feedback">Feedback</a> | <a href="../signup">Sign up</a></h2>
		<hr>
		<h1 class="title">FAQ</h1>
		<h1 id="countdown">IGNITE THE PAST. UNITE THE FUTURE.</h1>
