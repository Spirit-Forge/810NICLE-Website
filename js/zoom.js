...
function addZoomEventListeners() {
    ...
    for (var i = 0; i < trailerButtons.length; i++) {
        trailerButtons[i].addEventListener("click", function () {
            ...
            document.body.appendChild(zoom);
            zoom.innerHTML += '<div class="container"><iframe class="responsive-iframe" width="1920" height="1080" src="https://www.youtube.com/embed/hL2jucue92Q?autoplay=1&vq=1080" title="Trailer" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>';
