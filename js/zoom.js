...
function addZoomEventListeners() {
    ...
    for (var i = 0; i < trailerButtons.length; i++) {
        trailerButtons[i].addEventListener("click", function () {
            ...
            document.body.appendChild(zoom);
            zoom.innerHTML += '<iframe width="560" height="315" src="https://www.youtube.com/watch?v=1dRfg_r6oOg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
